...
def main(cfg: Config):
    ...
    trainer.compile(optimizer=optimizer, scheduler=lr_scheduler)  # compile method in utils/torch/trainer.py
    trainer.fit(train_ds, cfg.num_epochs, test_ds, callbacks=[ckpt_callback])

def arg_parser():
    parser = argparse.ArgumentParser()
    parser.add_argument("-cfg", "--config", type=str, default="../src/config/base.py")
