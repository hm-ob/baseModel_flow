...
class Config(BaseConfig):
    ...
    def set_args(self, **kwargs):
        ...
        self.learning_rate_step_size: int = 5
        self.learning_rate_gamma: float = 0.5

        self.optimizer_type: str = "AdamW" # Adam, SGD, AdamW
        # Adam config
        ...
        self.data_root: str = (
            "./MSP-Podcast_preprocessed" # folder contains train.pkl and test.pkl
        )
        self.data_valid: str = (
            "val.pkl" # 検証データなしならtest.pkl
        )
        self.num_workers = 2
        ...
        self.text_unfreeze: bool = False # BERTを凍結
        ...
        self.fusion_head_output_type: str = "mean"

        # Search for linear layer output demension
        self.linear_layer_output: List = [512, 256] # [256, 128]
